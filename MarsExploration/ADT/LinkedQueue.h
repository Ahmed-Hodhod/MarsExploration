...
/*
* use Enqueue_By_Priority to have a priority queue 
*/
class Node
{
private:
...
public:
	...
	// Use this function to have a priority queue 
	//bool Enqueue_By_Priority(const T& newEntry, int pri);
...
//template<typename T>
//inline bool LinkedQueue<T>::Enqueue_By_Priority(const T& newEntry, int pri)
//{
...
template<typename T>
inline Node<T>* LinkedQueue<T>::get_FrontPtr()
{
	return frontPtr;
}
